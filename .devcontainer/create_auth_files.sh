...
for dir in order_enricher token_gen transaction_fetcher non_sale_charge_to_transaction shipping_label_to_transaction sale_to_transaction sale_to_transaction
do
